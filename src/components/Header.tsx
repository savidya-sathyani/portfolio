...
export default function Header() {
  ...
  return (
    <section className="h-8 flex item-end justify-between sm:h-14 mt-3">
      <div className="flex justify-between space-x-10">
        <Link to="/" className="w-32 sm:w-52 relative z-10">
          <img
            src={theme === 'light' ? LogoLight : LogoDark}
            alt="Savidya's Portfolio"
            title="Savidya's Portfolio"
          />
        </Link>

        <div className="hidden items-end space-x-9 sm:flex">
          <Link to="/" className="nav-link item-hover">
            Home
          </Link>
          <Link to="/" className="nav-link item-hover">
            Projects
      ...
      <div className="items-end space-x-0.5 hidden sm:flex">
        <button
          className="icon-button item-hover"
