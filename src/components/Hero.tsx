      ...
      <div className="hero-section-animation">
        <div className="hero-section-animation-container group lg:ml-36">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="hero-circle w-[290px] h-[290px] md:w-[340px] md:h-[340px] lg:w-[370px] lg:h-[370px] animate-hero-pulse delay-1000"></div>
            <div className="hero-circle  w-[330px] h-[330px] md:w-[370px] md:h-[370px] lg:w-[430px] lg:h-[430px] animate-hero-pulse delay-2000"></div>
            <div className="hero-circle w-[370px] h-[370px] md:w-[410px] md:h-[410px] lg:w-[490px] lg:h-[490px] animate-hero-pulse delay-3000"></div>
          </div>
